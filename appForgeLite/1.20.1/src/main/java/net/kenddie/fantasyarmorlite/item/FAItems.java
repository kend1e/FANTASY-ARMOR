...
import net.kenddie.fantasyarmorlite.item.armor.*;
...
public final class FAItems {
    ...
    public static final RegistryObject<Item> CHESS_BOARD_HELMET = ITEMS.register("chess_board_knight_helmet", () -> new ChessBoardKnightArmorItem(ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> CHESS_BOARD_CHESTPLATE = ITEMS.register("chess_board_knight_chestplate", () -> new ChessBoardKnightArmorItem(ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> CHESS_BOARD_LEGGINGS = ITEMS.register("chess_board_knight_leggings", () -> new ChessBoardKnightArmorItem(ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> CHESS_BOARD_BOOTS = ITEMS.register("chess_board_knight_boots", () -> new ChessBoardKnightArmorItem(ArmorItem.Type.BOOTS));

    public static final RegistryObject<Item> DARK_LORD_HELMET = ITEMS.register("dark_lord_helmet", () -> new DarkLordArmorItem(ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> DARK_LORD_CHESTPLATE = ITEMS.register("dark_lord_chestplate", () -> new DarkLordArmorItem(ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> DARK_LORD_LEGGINGS = ITEMS.register("dark_lord_leggings", () -> new DarkLordArmorItem(ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> DARK_LORD_BOOTS = ITEMS.register("dark_lord_boots", () -> new DarkLordArmorItem(ArmorItem.Type.BOOTS));

    public static final RegistryObject<Item> SUNSET_WINGS_HELMET = ITEMS.register("sunset_wings_helmet", () -> new SunsetWingsArmorItem(ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> SUNSET_WINGS_CHESTPLATE = ITEMS.register("sunset_wings_chestplate", () -> new SunsetWingsArmorItem(ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> SUNSET_WINGS_LEGGINGS = ITEMS.register("sunset_wings_leggings", () -> new SunsetWingsArmorItem(ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> SUNSET_WINGS_BOOTS = ITEMS.register("sunset_wings_boots", () -> new SunsetWingsArmorItem(ArmorItem.Type.BOOTS));
