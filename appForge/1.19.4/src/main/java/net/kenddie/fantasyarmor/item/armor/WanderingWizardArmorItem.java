...
public class WanderingWizardArmorItem extends FAArmorItem {
    public WanderingWizardArmorItem(Type type, FAArmorAttributes armorAttributes) {
    ...
    public List<MobEffectInstance> getFullSetEffects() {
        return List.of(
                new MobEffectInstance(MobEffects.WATER_BREATHING, 239, 0, true, showParticles, true),
