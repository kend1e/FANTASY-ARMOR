...
public class DarkCoverArmorItem extends FAArmorItem {

    public DarkCoverArmorItem(Type type, double knockbackResistance, double movementSpeed, double maxHealth, double attackDamage, double attackSpeed, double luck) {
    ...
    protected GeoArmorRenderer<? extends FAArmorItem> createArmorRenderer() {
        return new FAArmorRenderer<>(new FAArmorModel<>(
                "geo/dark_cover_armor.geo.json",
                "textures/armor/dark_cover_armor.png"
        ));
    }
}