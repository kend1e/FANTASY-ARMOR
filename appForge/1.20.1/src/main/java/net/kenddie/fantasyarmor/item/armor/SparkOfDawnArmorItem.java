...
public class SparkOfDawnArmorItem extends FAArmorItem {
    ...
    public SparkOfDawnArmorItem(Type type, double knockbackResistance, double movementSpeed, double maxHealth, double attackDamage, double attackSpeed, double luck) {
