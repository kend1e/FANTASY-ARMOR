...
public final class FAItems {
    ...
    public static final RegistryObject<Item> CHESS_BOARD_KNIGHT_HELMET = ITEMS.register("chess_board_knight_helmet", () -> new ChessBoardKnightArmorItem(ArmorItem.Type.HELMET,    0.2, 0, 0, 0, 0, 0));
    public static final RegistryObject<Item> CHESS_BOARD_KNIGHT_CHESTPLATE = ITEMS.register("chess_board_knight_chestplate", () -> new ChessBoardKnightArmorItem(ArmorItem.Type.CHESTPLATE,    0.2, 0, 2.0, 0, 0, 0));
    public static final RegistryObject<Item> CHESS_BOARD_KNIGHT_LEGGINGS = ITEMS.register("chess_board_knight_leggings", () -> new ChessBoardKnightArmorItem(ArmorItem.Type.LEGGINGS,    0.2, 0, 0, 0, 0, 0));
    public static final RegistryObject<Item> CHESS_BOARD_KNIGHT_BOOTS = ITEMS.register("chess_board_knight_boots", () -> new ChessBoardKnightArmorItem(ArmorItem.Type.BOOTS,    0.2, 0, 2.0, 0, 0, 0));
