...
public class LadyMariaArmorItem extends FAArmorItem {
    public LadyMariaArmorItem(Type type, double knockbackResistance, double movementSpeed, double maxHealth, double attackDamage, double attackSpeed, double luck) {
