...
public class GoldenExecutionArmorItem extends FAArmorItem {

    public GoldenExecutionArmorItem(Type type, double knockbackResistance, double movementSpeed, double maxHealth, double attackDamage, double attackSpeed, double luck) {
    ...
    protected GeoArmorRenderer<? extends FAArmorItem> createArmorRenderer() {
        return new FAArmorRenderer<>(new FAArmorModel<>(
                "geo/golden_execution_armor.geo.json",
                "textures/armor/golden_execution_armor.png"
        ));
    }
}
