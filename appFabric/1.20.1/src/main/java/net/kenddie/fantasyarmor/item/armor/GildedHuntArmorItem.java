...
public class GildedHuntArmorItem extends FAArmorItem {
    ...
    public GildedHuntArmorItem(Type type, double knockbackResistance, double movementSpeed, double maxHealth, double attackDamage, double attackSpeed, double luck) {
