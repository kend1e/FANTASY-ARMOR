...
public class RedeemerArmorItem extends FAArmorItem {

    public RedeemerArmorItem(Type type, double knockbackResistance, double movementSpeed, double maxHealth, double attackDamage, double attackSpeed, double luck) {
    ...
    protected GeoArmorRenderer<? extends FAArmorItem> createArmorRenderer() {
        return new FAArmorRenderer<>(new FAArmorModel<>(
                "geo/redeemer_armor.geo.json",
                "textures/armor/redeemer_armor.png"
        ));
    }
}